	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FloatingipV1alpha1().FloatingIPs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FloatingipV1alpha1().FloatingIPs(namespace).Watch(context.TODO(), options)
			},
		},
		&floatingipv1alpha1.FloatingIP{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *floatingIPInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&floatingipv1alpha1.FloatingIP{}, f.defaultInformer)
}
