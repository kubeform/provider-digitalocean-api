...
import (
	...
	v1alpha1 "kubeform.dev/provider-digitalocean-api/client/listers/floatingip/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FloatingipV1alpha1().Assignments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FloatingipV1alpha1().Assignments(namespace).Watch(context.TODO(), options)
			},
		},
		&floatingipv1alpha1.Assignment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *assignmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&floatingipv1alpha1.Assignment{}, f.defaultInformer)
}
