	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatabaseV1alpha1().Replicas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatabaseV1alpha1().Replicas(namespace).Watch(context.TODO(), options)
			},
		},
		&databasev1alpha1.Replica{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *replicaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&databasev1alpha1.Replica{}, f.defaultInformer)
}
