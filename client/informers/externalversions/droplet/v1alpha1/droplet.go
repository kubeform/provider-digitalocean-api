	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DropletV1alpha1().Droplets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DropletV1alpha1().Droplets(namespace).Watch(context.TODO(), options)
			},
		},
		&dropletv1alpha1.Droplet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dropletInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dropletv1alpha1.Droplet{}, f.defaultInformer)
}
