...
import (
	...
	v1alpha1 "kubeform.dev/provider-digitalocean-api/client/listers/custom/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Images(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Images(namespace).Watch(context.TODO(), options)
			},
		},
		&customv1alpha1.Image{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customv1alpha1.Image{}, f.defaultInformer)
}
