...
import (
	...
	v1alpha1 "kubeform.dev/provider-digitalocean-api/client/listers/kubernetes/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KubernetesV1alpha1().NodePools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubernetesV1alpha1().NodePools(namespace).Watch(context.TODO(), options)
			},
		},
		&kubernetesv1alpha1.NodePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubernetesv1alpha1.NodePool{}, f.defaultInformer)
}
