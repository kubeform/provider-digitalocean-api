...
import (
	...
	v1alpha1 "kubeform.dev/provider-digitalocean-api/client/listers/monitor/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitorV1alpha1().Alerts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitorV1alpha1().Alerts(namespace).Watch(context.TODO(), options)
			},
		},
		&monitorv1alpha1.Alert{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *alertInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitorv1alpha1.Alert{}, f.defaultInformer)
}
