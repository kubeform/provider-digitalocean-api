...
type Interface interface {
	...
	// Resourceses returns a ResourcesInformer.
	Resourceses() ResourcesInformer
}
...
// Resourceses returns a ResourcesInformer.
func (v *version) Resourceses() ResourcesInformer {
	return &resourcesInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
