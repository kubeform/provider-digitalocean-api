...
type Interface interface {
	...
	// DockerCredentialses returns a DockerCredentialsInformer.
	DockerCredentialses() DockerCredentialsInformer
}
...
// DockerCredentialses returns a DockerCredentialsInformer.
func (v *version) DockerCredentialses() DockerCredentialsInformer {
	return &dockerCredentialsInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
