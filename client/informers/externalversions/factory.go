...
import (
	...
	floatingip "kubeform.dev/provider-digitalocean-api/client/informers/externalversions/floatingip"
	...
	ssh "kubeform.dev/provider-digitalocean-api/client/informers/externalversions/ssh"
...
func (f *sharedInformerFactory) Containerregistry() containerregistry.Interface {
	return containerregistry.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Droplet() droplet.Interface {
	return droplet.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Floatingip() floatingip.Interface {
	return floatingip.New(f, f.namespace, f.tweakListOptions)
}
...
func (f *sharedInformerFactory) Record() record.Interface {
	return record.New(f, f.namespace, f.tweakListOptions)
}

func (f *sharedInformerFactory) Spacesbucket() spacesbucket.Interface {
	return spacesbucket.New(f, f.namespace, f.tweakListOptions)
}
