...
type FakeFloatingIPs struct {
	Fake *FakeFloatingipV1alpha1
	ns   string
}

var floatingipsResource = schema.GroupVersionResource{Group: "floatingip.digitalocean.kubeform.com", Version: "v1alpha1", Resource: "floatingips"}

var floatingipsKind = schema.GroupVersionKind{Group: "floatingip.digitalocean.kubeform.com", Version: "v1alpha1", Kind: "FloatingIP"}
