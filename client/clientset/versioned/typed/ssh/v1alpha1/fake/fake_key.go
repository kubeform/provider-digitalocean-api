...
var keysResource = schema.GroupVersionResource{Group: "ssh.digitalocean.kubeform.com", Version: "v1alpha1", Resource: "keys"}

var keysKind = schema.GroupVersionKind{Group: "ssh.digitalocean.kubeform.com", Version: "v1alpha1", Kind: "Key"}
