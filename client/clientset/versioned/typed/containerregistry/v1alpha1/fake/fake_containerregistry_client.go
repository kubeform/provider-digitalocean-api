...
import (
	...
	v1alpha1 "kubeform.dev/provider-digitalocean-api/client/clientset/versioned/typed/containerregistry/v1alpha1"
)
...
func (c *FakeContainerregistryV1alpha1) DockerCredentialses(namespace string) v1alpha1.DockerCredentialsInterface {
	return &FakeDockerCredentialses{c, namespace}
}

// RESTClient returns a RESTClient that is used to communicate
// with API server by this client implementation.
func (c *FakeContainerregistryV1alpha1) RESTClient() rest.Interface {
