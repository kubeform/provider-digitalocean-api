...
var containerregistriesResource = schema.GroupVersionResource{Group: "containerregistry.digitalocean.kubeform.com", Version: "v1alpha1", Resource: "containerregistries"}

var containerregistriesKind = schema.GroupVersionKind{Group: "containerregistry.digitalocean.kubeform.com", Version: "v1alpha1", Kind: "ContainerRegistry"}
...
func (c *FakeContainerRegistries) UpdateStatus(ctx context.Context, containerRegistry *v1alpha1.ContainerRegistry, opts v1.UpdateOptions) (*v1alpha1.ContainerRegistry, error) {
	obj, err := c.Fake.
