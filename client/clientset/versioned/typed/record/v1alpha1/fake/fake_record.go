...
type FakeRecords struct {
	Fake *FakeRecordV1alpha1
	ns   string
}

var recordsResource = schema.GroupVersionResource{Group: "record.digitalocean.kubeform.com", Version: "v1alpha1", Resource: "records"}

var recordsKind = schema.GroupVersionKind{Group: "record.digitalocean.kubeform.com", Version: "v1alpha1", Kind: "Record"}
