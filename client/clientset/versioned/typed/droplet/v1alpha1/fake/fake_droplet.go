...
var dropletsResource = schema.GroupVersionResource{Group: "droplet.digitalocean.kubeform.com", Version: "v1alpha1", Resource: "droplets"}

var dropletsKind = schema.GroupVersionKind{Group: "droplet.digitalocean.kubeform.com", Version: "v1alpha1", Kind: "Droplet"}
...
func (c *FakeDroplets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Droplet, err error) {
	...
	return obj.(*v1alpha1.Droplet), err
}
...
func (c *FakeDroplets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DropletList, err error) {
	...
	list := &v1alpha1.DropletList{ListMeta: obj.(*v1alpha1.DropletList).ListMeta}
	for _, item := range obj.(*v1alpha1.DropletList).Items {
